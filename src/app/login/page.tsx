  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50/50 to-white flex flex-col items-center justify-center px-6">
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl font-semibold text-stone-800 mb-2">Glow</h1>
        <p className="text-sm text-stone-500">Your personal skincare tracker</p>
      </div>
      ...
      <p className="text-xs text-stone-400 mt-8 text-center max-w-xs">
        Sign in to sync your skincare routine across all your devices
      </p>
    </div>
  );
}
